package org.unicorn.framework.cache.cookies;
 ...
 *
 */
public class CustomerCookieSerializer  extends DefaultCookieSerializer{
	...
	private String base64Decode(String base64Value) {
		try {
			byte[] decodedCookieBytes = Base64Util.encodeByte(base64Value.getBytes());
	...
	private String base64Encode(String value) {
		byte[] encodedCookieBytes = Base64Util.encodeByte(value.getBytes());
