...
public abstract class UnicornAbstractGenerator {
    ...
    public void batchOutput(String entityName, VelocityContext context) {
        try {
            ...
            //是否生成entity文件
            if (globalConfig.getFileTypes().contains(UnicornFileType.entity)) {
                //实体类路径
            ...
            //是否启用Example
            if (globalConfig.getFileTypes().contains(UnicornFileType.entityExample)) {
                //实体对应的Example类路径
            ...
            //是否启用mapper
            if (globalConfig.getFileTypes().contains(UnicornFileType.mapper)) {
                //DAO接口文件路径
            ...
            //是否启用xml
            if (globalConfig.getFileTypes().contains(UnicornFileType.xml)) {
                //映射文件路径
            ...
            //是否启用xml
            if (globalConfig.getFileTypes().contains(UnicornFileType.serviceImpl)) {
                //service实现类路径
            ...
            //是否启用dto
            if (globalConfig.getFileTypes().contains(UnicornFileType.dto)) {
                //dto类路径
            ...
            if (pathInfo.get(UnicornConstVal.API_CONTROLLER_PATH) != null) {
                //是否启用apiController
                if (globalConfig.getFileTypes().contains(UnicornFileType.apiController)) {
                ...
                //是否启用apiServiceImpl
                if (globalConfig.getFileTypes().contains(UnicornFileType.apiServiceImpl)) {
