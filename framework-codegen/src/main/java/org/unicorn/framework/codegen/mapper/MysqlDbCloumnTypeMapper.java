...
public class MysqlDbCloumnTypeMapper {
	...
	static {
		...
		_MAP.put("DATE", new DbCloumnTypeInfo("DATE", "java.time.LocalDate","java.util.Date"));
		_MAP.put("TIME", new DbCloumnTypeInfo("TIME", "java.time.LocalTime","java.sql.Time"));
		_MAP.put("TIMESTAMP", new DbCloumnTypeInfo("TIMESTAMP", "java.time.LocalDateTime","java.util.Date"));
		_MAP.put("DATETIME", new DbCloumnTypeInfo("DATETIME", "java.time.LocalDateTime","java.util.Date"));
