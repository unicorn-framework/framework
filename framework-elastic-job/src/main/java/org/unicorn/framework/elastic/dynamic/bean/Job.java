 ...
 */
@Data
@ApiModel(value = "job对象", description = "job对象")
public class Job extends AbstractRequestDto {
...
/*********************DataflowJobConfiguration START********************/
     ...
     * @return
     */
    @ApiModelProperty(value = "job名称", name = "job名称")
     ...
     * 任务类路径
     */
    @ApiModelProperty(value = "job类路径", name = "job类路径")
     ...
     * @return
     */
    @ApiModelProperty(value = "crom表达式", name = "crom表达式")
    private String cron;
     ...
     * @return
     */
    @ApiModelProperty(value = "作业分片总数", name = "作业分片总数")
     ...
     * @return
     */
    @ApiModelProperty(value = "分片序列号和参数键值对", name = "分片序列号和参数键值对")
     ...
     * @return
     */
    @ApiModelProperty(value = "作业自定义参数", name = "作业自定义参数")
     ...
     * @return
     */
    @ApiModelProperty(value = "是否开启任务执行失效转移", name = "是否开启任务执行失效转移")
     ...
     * @return
     */
    @ApiModelProperty(value = "是否开启错过任务重新执行", name = "是否开启错过任务重新执行")
